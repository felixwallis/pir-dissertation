...
## Using `searchK` to find the optimal number of topics for a topic model with an interaction between `affiliation` and `country`, with `date_as_numeric` added as a covariate
